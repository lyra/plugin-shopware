...
EOT;
    ...
    public function finalize(
        ...
        if ($this->isNewOrderTransaction($orderTransaction, $lyraResponse)) {
            ...
            $newPaymentStatus = $this->getNewOrderPaymentStatus($lyraResponse);
            ...
            // Update order status.
            $this->orderService->saveOrderStatus($context, $transaction->getOrderTransaction()->getOrderId(), $this->getNewOrderTransition($lyraResponse));
     ...
     * @return string
     */
    private function getNewOrderPaymentStatus(LyraResponse $lyraResponse, ?string $salesChannelId = null)
    {
     ...
     * @return string
     */
    private function getNewOrderTransition(LyraResponse $lyraResponse)
    {
        $status = $lyraResponse->get('trans_status');
